...
def test_encode_decode_short():
    ...
    os.remove("_test_img.png")
    os.remove("_test_enc.png")
...
def test_encode_decode_long():
    ...
    os.remove("_test_img2.png")
    os.remove("_test_enc2.png")
...
def test_pixel_diff_is_0_or_1():
    ...
    os.remove("_test_img3.png")
    os.remove("_test_enc3.png")
...
def test_special_characters():
    ...
    os.remove("_test_special.png")
    os.remove("_test_special_enc.png")
